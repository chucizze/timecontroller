...
routedict = {
    ...
    centerservice.Personalcencer: "/v1/secondbook/personalcenter/show/",  # 显示我的个人中心首页测试通过
    centerservice.Ownattention: "/v1/secondbook/ownattention/show/",  # 查看自己的关注测试通过
    centerservice.CancleAttention: "/v1/secondbook/cancel/attentionbutton/",  # 取消关注测试成功
    centerservice.OwnFans: "/v1/secondbook/ownfans/show/",  # 查看自己的粉丝测试通过
    centerservice.AddAttention: "/v1/secondbook/add/attentionbutton/",  # 关注他人测试通过
}