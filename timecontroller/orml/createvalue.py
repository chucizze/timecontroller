...
if session.query(Userinfo).count() == 0:
    userinfolist = [Userinfo(userinfo_id=1, userinfo_name="小红", userinfo_img="timer.jgp", userinfo_userid=1, userinfo_attentionnum=1,userinfo_fansnum=1),
                    Userinfo(userinfo_id=2, userinfo_name="小明", userinfo_img="timer.jgp",  userinfo_userid=2,userinfo_attentionnum=2,userinfo_fansnum=1),
                    Userinfo(userinfo_id=3, userinfo_name="小蓝", userinfo_img="timer.jgp", userinfo_userid=3,userinfo_attentionnum=3,userinfo_fansnum=3),
                    Userinfo(userinfo_id=4, userinfo_name="小绿", userinfo_img="timer.jgp", userinfo_userid=4,userinfo_attentionnum=4,userinfo_fansnum=4),
                    Userinfo(userinfo_id=5, userinfo_name="小黄", userinfo_img="timer.jgp",  userinfo_userid=5,userinfo_attentionnum=5,userinfo_fansnum=5)]
...
if session.query(Comment).count() ==0:
    commentlist = [
        ...
        Comment(comment_id=6, comment_content="这家店好吃", comment_time="2019-12-09 09:23:08", comment_userinfoid=4,comment_forumid=6),
